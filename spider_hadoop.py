...
def get_deatail(id):
    ...
    headers = {
        "Host": "www.lagou.com",
        "Referer": "https://www.lagou.com/jobs/list_%E5%A4%A7%E6%95%B0%E6%8D%AE?city=%E5%8C%97%E4%BA%AC&cl=false&fromSearch=true&labelWords=&suginput=",
...
def getUrlStr():
    ...
    for x in range(2, 11):
        ...
        with open("lagou_hadoop1.json", "w") as fp:
